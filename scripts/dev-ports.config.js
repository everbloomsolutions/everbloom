 ...
 * Prevents EADDRINUSE: each service has a distinct port. Compatible with container platforms (PORT), Vercel (serverless), AWS.
 *
 * Service       | Port  | Env (override)
 * Backend API   | 8080  | PORT (container platforms/AWS) or BACKEND_PORT (dev)
