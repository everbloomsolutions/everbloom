 ...
 */
export const getLocationTypeLabel = (type: CollectionLocationType | string | null | undefined): string => {
...
/**
 * Material type enum array for use in Mongoose/Zod schemas
 */
export const MATERIAL_TYPE_ENUM = Object.values(MATERIAL_TYPES) as [MaterialType, ...MaterialType[]];
